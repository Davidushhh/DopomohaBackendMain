  ...
  try {
    ...
    const creditCompensation = {
      ...
      content: [
        ...
        {
          text: ` З вимогами Порядку використання коштів обласного бюджету для компенсації частини відсоткових ставок за користування кредитами у межах Державної програми „Доступні кредити 5-7-9%” суб’єктам господарювання переробної галузі промисловості, які здійснюють виробництво кінцевої продукції для споживача, та/або сільськогосподарським товаровиробникам у рамках реалізації Програми розвитку малого та середнього підприємництва у Закарпатській області на 2025 – 2027 роки, ознайомлений та зобов’язуюся їх виконувати.`,
          alignment: "justify",
          fontSize: 11,
          margin: [0, 0, 0, 0],
        },
        {
          text: ` Зобов’язуюся повернути Департаменту кошти фінансової підтримки у повному обсязі у разі невиконання взятих зобов’язань щодо збільшення обсягів виробництва кінцевої продукції для споживача та/або збільшення кількості найманих працівників, зростання суми сплачених податків і зборів до бюджетів, впровадження інноваційних технологій, модернізації основних засобів тощо.`,
          alignment: "justify",
          fontSize: 11,
          margin: [0, 0, 0, 0],
        },
